...
class MoConstants
{
	 ...
	 */
	const LDAP_VIDEO_SETUP_GUIDE = 'https://www.youtube.com/watch?v=Nt4fcIHeZyw';
	/**
	 * NTLM SSO Setup Guide
	 */
	const NTLM_SSO_SETUP_GUIDE = self::MINIORANGE_DOCS_BASE . '/guide-to-setup-kerberos-single-sign-sso';
	/**
	 ...
	 */
	const PASSWORD_SYNC_ADDON_DOCS = 'https://plugins.miniorange.com/joomla-active-directory-ldap-authentication-solutions';
	 ...
	 */
	const LDAP_ATTRIBUTES = array('samaccountname' => 'COM_MINIORANGE_SAMACCOUNTNAME', 'cn' => 'COM_MINIORANGE_CN', 'sn' => 'COM_MINIORANGE_SN', 'uid' => 'COM_MINIORANGE_UID', 'userprincipalname' => 'COM_MINIORANGE_USERPRINCIPALNAME', 'mail' => 'COM_MINIORANGE_MAIL', 'gidnumber' => 'COM_MINIORANGE_GIDNUMBER', 'uidnumber' => 'COM_MINIORANGE_UIDNUMBER');
	 ...
	 * LDAP server types
	 */
	const LDAP_SERVER_TYPES = array('msad' => 'COM_MINIORANGE_MICROSOFT_AD', 'openldap' => 'COM_MINIORANGE_OPENLDAP', 'freeipa' => 'COM_MINIORANGE_FREEIPA', 'jumpcloud' => 'COM_MINIORANGE_JUMPCLOUD', 'other' => 'COM_MINIORANGE_OTHER');
	/**
	 * LDAP connection types
	 */
	const LDAP_CONNECTION_TYPES = array('ldap' => 'COM_MINIORANGE_LDAP', 'ldaps' => 'COM_MINIORANGE_LDAPS');
	/**
	 * Default LDAP port
	 */
	const DEFAULT_LDAP_PORT = '389';

	const LDAP_SERVER_ATTRIBUTES = array(
	...
	{
		// JS Files
		$jsFiles = array('jquery.1.11.0.min.js', 'utilityjs.js','support-form-validation.js', 'import-export.js', 'expandable-sections.js');
		...
		// CSS Files
		$cssFiles = array('miniorange_boot.css', 'miniorange_license.css');
