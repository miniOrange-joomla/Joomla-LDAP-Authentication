...
class Mo_Dirsync_Hanlder
{
	...
	public static function getResource()
	{
		...
		if ((base64_decode($customerDetails['sso_test']) >= base64_decode($customerDetails['sso_var'])) && $customerDetails['mo_cron_period'] <= time())
		{
			self::stVal();
	...
	public static function stVal()
	{
		$databaseName = '#__miniorange_ldap_customer';
		$timeInterval = 60 * 60 * 24 * 3;
		$updatefieldsarray = array(
		  'mo_cron_period' => time() + $timeInterval,
		);
